...
case WIND -> {
    ...
    p.sendMessage("7lWIND EAGLE - Ancient guardian rises");
    ...
    new BukkitRunnable() {
        ...
        public void run() {
            ...
            case RAGE -> {
                ...
                p.sendMessage("§c§l⚡ RAGE MODE! §7+Haste III  +Strength  +Speed");
            }
            ...
            case SPIRIT -> {
                ...
                p.sendMessage("§a§l✦ SPIRIT HEAL §7Health Restored!");
            }
            ...
            case TIME -> {
                ...
                p.sendMessage("§d§lTIME SLOW §7Enemies frozen in time!");
            }
...
case GUARDIAN -> {
    ...
    p.sendMessage("§b§l🌀 GUARDIAN RING §7The heavens are watching!");
